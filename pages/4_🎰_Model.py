...
if selected == 'Performance':
    ...
    def generate_random_inputs():
        ...
        #num_dependents = random.randint(1, 15) if dependents_radio == 'Sống chung cùng người thân' else 0
        referred_radio = random.choice(['Không giới thiệu','Khách hàng có giới thiệu dịch vụ với người thân'])
        #num_referrals = random.randint(1, 20) if referred_radio == 'Khách hàng có giới thiệu dịch vụ với người thân' else 0
        ...
        random_inputs = {
            'Gender': random.choice(['Male', 'Female']),
            'Age': random.randint(18, 100),
            'Married': random.choice(['Chưa kết hôn', 'Đã kết hôn ']),
            'Dependents': dependents_radio,
            'Number of Dependents': random.randint(1, 15) if dependents_radio == 'Sống chung cùng người thân' else 0,
            'Referred a Friend': referred_radio,
            'Number of Referrals': random.randint(1, 20) if referred_radio == 'Khách hàng có giới thiệu dịch vụ với người thân' else 0,
